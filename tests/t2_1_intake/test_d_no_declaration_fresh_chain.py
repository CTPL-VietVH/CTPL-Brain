...
def test_undeclared_upload_starts_its_own_version_chain_at_ordinal_one(fingerprint_index):
...
def test_two_unrelated_undeclared_uploads_get_different_version_chains(fingerprint_index):
